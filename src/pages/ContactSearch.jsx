...
import { CF_QUICK_LINKS, DEFAULT_FILTERS } from '../data/contactSearchConstants'
import {
  filterCalls,
    ...
    <>
      ...
      <div className="page">
        ...
        <div className="briefing-subtitle">
          QA analysts &amp; team leaders · 2,250 merchant contacts · Filter, sort, and review call-level QA scorecards
        </div>
